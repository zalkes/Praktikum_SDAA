...
void hapusMusik(infomusik*& head) {
    ...
    if (urutan == 1) {
        ...
        cout << "\nBerhasil Menghapus (" << temp->next->lagu.judul << " - " << temp->next->lagu.artist << ") dari Playlist" << endl;
        temp->next = temp->next->next;
    }
    Sleep(1000);
}

bool hapusMusik_awal(infomusik*& head) {
    system("cls");
    if (head == nullptr) {
        cout << "Playlist Anda Kosong" << endl;
        Sleep(1000);
...
bool hapusMusik_akhir(infomusik*& head) {
    system("cls");
    if (head == nullptr) {
        cout << "Playlist Anda Kosong" << endl;
        Sleep(1000);
